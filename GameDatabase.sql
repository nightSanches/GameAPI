...
--
-- Хост: 127.0.0.1:3316
-- Время создания: Июн 10 2026 г., 20:58
...
(5, 1, 'Ночной дозор', 'Пережить ночь в Деловом районе', 'event_night', 1, 250),
(6, 1, 'Сейсмостоустойчивость', 'Пережить землетрясение в Деловом районе', 'event_shake', 1, 400),
(7, 1, 'Повелитель ветра', 'Пережить сильный ветер в Деловом районе', 'event_wind', 1, 600),
(8, 1, 'Первая десятка!', 'Набрать 10 000 очков в Деловом районе', 'score_1', 10000, 200),
(9, 1, 'Знаток своего дела', 'Достичь 30 000 очков в Деловом районе', 'score_2', 30000, 500),
(10, 1, 'Профессиональный строитель', 'Преодолеть отметку в 60 000 очков в Деловом районе', 'score_3', 50000, 1000),
(11, 1, 'Эверест', 'Набрать 100 000 очков в Деловом районе', 'score_4', 75000, 2000),
(12, 1, 'Идеальная десятка', 'Построить 10 идеальных этажей подряд в Деловом районе', 'ideal_1', 10, 250),
(13, 1, 'Двадцать без изъяна', 'Построить 20 идеальных этажей подряд в Деловом районе', 'ideal_2', 15, 700),
(14, 1, 'Ровно в ряд', 'Построить 50 идеальных этажей в одном забеге в Деловом районе', 'all_ideal_1', 40, 500),
(15, 1, 'Построено на века', 'Построить 100 идеальных этажей в одном забеге в Деловом районе', 'all_ideal_2', 80, 1200),
(16, 2, 'Укротитель тьмы', 'Пережить ночь в Центре города', 'event_night', 1, 750),
(17, 2, 'Крепыш', 'Пережить землетрясение в Центре города', 'event_shake', 1, 1200),
(18, 2, 'Непоколебимый', 'Пережить сильный ветер в Центре города', 'event_wind', 1, 1800),
(19, 2, 'Первая городская', 'Набрать 10 000 очков в Центре города', 'score_1', 10000, 600),
(20, 2, 'Архитектор среднего звена', 'Достичь 30 000 очков в Центре города', 'score_2', 25000, 1500),
(21, 2, 'Градостроительный магнат', 'Преодолеть отметку в 60 000 очков в Центре города', 'score_3', 45000, 3000),
(22, 2, 'Король небоскрёбов', 'Набрать 100 000 очков в Центре города', 'score_4', 70000, 5000),
(23, 2, 'Золотая серия', 'Построить 10 идеальных этажей подряд в Центре города', 'ideal_1', 10, 750),
(24, 2, 'Бриллиантовый пояс', 'Построить 30 идеальных этажей подряд в Центре города', 'ideal_2', 20, 2000),
(25, 2, 'Безупречный силуэт', 'Построить 50 идеальных этажей в одном забеге в Центре города', 'all_ideal_1', 40, 1500),
(26, 2, 'Город-совершенство', 'Построить 100 идеальных этажей в одном забеге в Центре города', 'all_ideal_2', 80, 3500),
(27, 3, 'Ночные эксперименты', 'Пережить ночь в Научном районе', 'event_night', 1, 2000),
(28, 3, 'Сдвиг по фазе', 'Пережить землетрясение в Научном районе', 'event_shake', 1, 3500),
(29, 3, 'Ветрянная мельница', 'Пережить сильный ветер в Научном районе', 'event_wind', 1, 5000),
(30, 3, 'Младший научный сотрудник', 'Набрать 10 000 очков в Научном районе', 'score_1', 10000, 1500),
(31, 3, 'Кандидат наук', 'Достичь 30 000 очков в Научном районе', 'score_2', 20000, 4000),
(32, 3, 'Нобелевский лоуреат', 'Преодолеть отметку в 60 000 очков в Научном районе', 'score_3', 40000, 8000),
(33, 3, 'Космический лифт', 'Набрать 100 000 очков в Научном районе', 'score_4', 65000, 14000),
(34, 3, 'Основы физики', 'Построить 10 идеальных этажей подряд в Научном районе', 'ideal_1', 10, 2000),
(35, 3, 'Квантовая механика', 'Построить 30 идеальных этажей подряд в Научном районе', 'ideal_2', 20, 5500),
(36, 3, 'Формула успеха', 'Построить 50 идеальных этажей в одном забеге в Научном районе', 'all_ideal_1', 35, 4000),
(37, 3, 'Ноль погрешности', 'Построить 100 идеальных этажей в одном забеге в Научном районе', 'all_ideal_2', 75, 9000);
...
(1, 'Стабилизатор', 'Временно уменьшает шатание крана', 150),
(2, 'Регулятор', 'Выравнивает небоскрёб по центру', 150),
(3, 'Магнит', 'Временно притягивает блоки к центру', 150);
...
(2, 'Центр города', 3000, '2.00', 2),
(3, 'Научный район', 12000, '3.50', 3);
