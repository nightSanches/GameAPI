...
--
-- Хост: 127.0.0.1:3316
-- Время создания: Июн 11 2026 г., 10:10
...
(10, 1, 'Профессиональный строитель', 'Преодолеть отметку в 50 000 очков в Деловом районе', 'score_3', 50000, 1000),
(11, 1, 'Эверест', 'Набрать 75 000 очков в Деловом районе', 'score_4', 75000, 2000),
(12, 1, 'Идеальная десятка', 'Построить 10 идеальных этажей подряд в Деловом районе', 'ideal_1', 10, 250),
(13, 1, 'Двадцать без изъяна', 'Построить 15 идеальных этажей подряд в Деловом районе', 'ideal_2', 15, 700),
(14, 1, 'Ровно в ряд', 'Построить 40 идеальных этажей в одном забеге в Деловом районе', 'all_ideal_1', 40, 500),
(15, 1, 'Построено на века', 'Построить 80 идеальных этажей в одном забеге в Деловом районе', 'all_ideal_2', 80, 1200),
...
(20, 2, 'Архитектор среднего звена', 'Достичь 25 000 очков в Центре города', 'score_2', 25000, 1500),
(21, 2, 'Градостроительный магнат', 'Преодолеть отметку в 45 000 очков в Центре города', 'score_3', 45000, 3000),
(22, 2, 'Король небоскрёбов', 'Набрать 70 000 очков в Центре города', 'score_4', 70000, 5000),
(23, 2, 'Золотая серия', 'Построить 10 идеальных этажей подряд в Центре города', 'ideal_1', 10, 750),
(24, 2, 'Бриллиантовый пояс', 'Построить 20 идеальных этажей подряд в Центре города', 'ideal_2', 20, 2000),
(25, 2, 'Безупречный силуэт', 'Построить 40 идеальных этажей в одном забеге в Центре города', 'all_ideal_1', 40, 1500),
(26, 2, 'Город-совершенство', 'Построить 80 идеальных этажей в одном забеге в Центре города', 'all_ideal_2', 80, 3500),
...
(31, 3, 'Кандидат наук', 'Достичь 20 000 очков в Научном районе', 'score_2', 20000, 4000),
(32, 3, 'Нобелевский лоуреат', 'Преодолеть отметку в 40 000 очков в Научном районе', 'score_3', 40000, 8000),
(33, 3, 'Космический лифт', 'Набрать 65 000 очков в Научном районе', 'score_4', 65000, 14000),
(34, 3, 'Основы физики', 'Построить 10 идеальных этажей подряд в Научном районе', 'ideal_1', 10, 2000),
(35, 3, 'Квантовая механика', 'Построить 20 идеальных этажей подряд в Научном районе', 'ideal_2', 20, 5500),
(36, 3, 'Формула успеха', 'Построить 35 идеальных этажей в одном забеге в Научном районе', 'all_ideal_1', 35, 4000),
(37, 3, 'Ноль погрешности', 'Построить 75 идеальных этажей в одном забеге в Научном районе', 'all_ideal_2', 75, 9000);
